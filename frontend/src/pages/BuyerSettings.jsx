...
const BuyerSettings = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    if (!/[A-Z]/.test(passwordData.newPassword)) passwordErrors.push('one uppercase letter');
    if (!/[a-z]/.test(passwordData.newPassword)) passwordErrors.push('one lowercase letter');
    if (!/[0-9]/.test(passwordData.newPassword)) passwordErrors.push('one number');
    if (!/[!@#$%^&*(),.?":{}|<>]/.test(passwordData.newPassword)) passwordErrors.push('one special character');
